<x-app-layout>
    <div class="mb-6">
        <h1 class="text-xl sm:text-2xl font-bold mb-2">Applicants for: {{ $opportunity->title ?? 'N/A' }}</h1>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-200">
                        <th class="border border-gray-200 p-2 sm:p-3 text-left text-sm font-semibold">Name</th>
                        <th class="border border-gray-200 p-2 sm:p-3 text-left text-sm font-semibold">Email</th>
                        <th class="border border-gray-200 p-2 sm:p-3 text-left text-sm font-semibold">Status</th>
                        <th class="border border-gray-200 p-2 sm:p-3 text-left text-sm font-semibold">Update Status</th>
                    </tr>
                </thead>
                <tbody>
